...
#        prec_deg = last_deg
    ...
    print "[DEBUG]nodes:"+str(graph.number_of_nodes())
    print "[DEBUG]edges:"+str(graph.number_of_edges())
    return graph
